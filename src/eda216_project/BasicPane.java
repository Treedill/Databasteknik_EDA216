...
public class BasicPane extends JPanel {
	...
	public BasicPane(Database db) {
		...
		leftPanels.setLayout(new BorderLayout());
		leftPanels.add(leftPanel, BorderLayout.WEST);
		leftPanels.add(leftTopPanel, BorderLayout.NORTH);
	...
	/**
	 * Create the left top panel. Should be overridden by subclasses.
	 *
	 * @return An empty panel.
	 */
	...
	/**
	 * Create the right bottom panel. Should be overridden by subclasses.
	 *
	 * @return An empty panel.
	 */
